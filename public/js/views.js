...
try {
  ...
  with (locals || {}) {
    ...
    ; __append("</div>\n                <div style=\"color: #00FF89; font-weight: bold; font-size: x-large;\">Score: ")
    ; __line = 34
    ...
    ; __line = 142
    ; __append(escapeFn( high_score._id))
    ; __append("\"></span></span>\n                </div>\n                <div>\n                  <span>Track moves: <span id=\"value-")
    ; __line = 145
    ; __append(escapeFn( high_score._id))
    ; __append("\"></span><input class=\"tracker-")
    ; __append(escapeFn( high_score._id))
    ; __append("\" style=\"width: 100% !important;\" type=\"range\" id=\"moves\" min=\"0\" max=\"")
...
try {
  ...
  with (locals || {}) {
    ...
    ; __append("\n            <div>\n              <div>")
    ; __line = 80
    ; __append(escapeFn(lobby.username))
    ; __append("</div>\n              <div>")
    ; __line = 81
    ; __append(escapeFn(lobby.diff))
    ; __append("</div>\n              <div>")
    ; __line = 82
    ; __append(escapeFn(lobby.size))
    ; __append("</div>\n              <div>\n                <a href=\"/waitroom/")
    ; __line = 84
    ; __append(escapeFn(lobby._id))
    ; __append("\">\n                  <button type=\"submit\">Join</button>\n                </a>\n              </div>\n            </div>\n          ")
    ; __line = 89
    ;  }) 
    ; __append("\n        </div>\n      </section>\n\n      ")
...
try {
  ...
  with (locals || {}) {
    ...
    ; __append("</span></p>\n          <div class=\"container\">\n            <div class=\"time\">\n              <span>Time: </span>\n              <span id=\"seconds\"> 00 </span>s\n          </div>\n            <div class=\"scores\">\n              <h2 id = \"errors\"><span>Score:</span> <span id=\"score\">")
    ; __line = 23
...
;
var __line = 1
  , __lines = "<html>\n    <%- include(\"includes/head\") %>\n    <head>\n        <link rel = \"stylesheet\" href = \"/styles/css/sudoku.css\">\n        <script src=\"/js/ejs.min.js\"></script>\n        <script src=\"/js/views.js\"></script>\n        <script src=\"/socket.io/socket.io.js\"></script>\n        <script src=\"/client_scripts/client_socket.js\"></script>\n    </head>\n    <body onload=\"socket_init()\">\n      <%- include(\"includes/header\") %>\n\n      <section class=\"main-section\">\n        \n        <main>\n            <h1>Sudoku</h1>\n            <hr>\n            \n                <ul>\n                    <li><h4>Connection Successful</h4></li>\n                    <li>\n                        <h4 id=\"players_ready\"> Players: <%=  %></h4>\n                        <h4>Difficulty: <%= lobby.diff %></h4>\n                        <h4>Room Size: <%= lobby.size %></h4> \n\n                    </li>\n                </ul>\n            </main>\n        </section>\n      <%- include(\"includes/footer\") %>\n    </body>\n\n</html>"
  , __filename = undefined;
try {
  var __output = "";
  function __append(s) { if (s !== undefined && s !== null) __output += s }
